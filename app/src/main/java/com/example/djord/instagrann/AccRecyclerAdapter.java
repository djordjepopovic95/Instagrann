...
public class AccRecyclerAdapter extends RecyclerView.Adapter<AccRecyclerAdapter.ViewHolder> {
    ...
    public AccRecyclerAdapter(List<InstaPost> blog_list, List<User> user_list) {
    ...
    @NonNull
    @Override
    public AccRecyclerAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.blog_list_item, parent, false);
        context = parent.getContext();
        firebaseFirestore = FirebaseFirestore.getInstance();
        firebaseAuth = FirebaseAuth.getInstance();
        return new AccRecyclerAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull final AccRecyclerAdapter.ViewHolder holder, final int position) {
